        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-amber-800 to-amber-600 rounded-lg shadow-xl mb-8">
                <div class="p-8 text-center">
                    ...
                    <p class="text-white text-lg mb-6">Nikmati racikan kopi pilihan dengan suasana yang nyaman dan harga bersahabat</p>
                    <button class="bg-white text-amber-800 px-6 py-2 rounded-full font-semibold hover:bg-amber-50 transition-colors">
                        Lihat Produk
                    </button>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600">Berbagai pilihan kopi dari biji pilihan: Arabika, Robusta, dan racikan spesial warung.</p>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600">Pelengkap kopi dengan cemilan tradisional dan modern yang menggugah selera.</p>
                    <div class="mt-4 space-y-2">
                        <div class="flex justify-between">
